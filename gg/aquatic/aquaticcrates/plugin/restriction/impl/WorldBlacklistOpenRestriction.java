...
public final class WorldBlacklistOpenRestriction extends OpenRestriction {
   ...
   public Boolean execute(@NotNull OpenData var1, @NotNull ObjectArguments var2, @NotNull Function2<? super OpenData, ? super String, String> var3) {
      ...
      Collection var10000 = var2.stringOrCollection("blacklist", WorldBlacklistOpenRestriction::execute$lambda$0);
      if (var10000 == null) {
         return true;
      } else {
         Collection var4 = var10000;
         Iterable var5 = (Iterable)var4;
         World var10001 = var1.getLocation().getWorld();
         return !CollectionsKt.contains(var5, var10001 != null ? var10001.getName() : null);
      }
   }
