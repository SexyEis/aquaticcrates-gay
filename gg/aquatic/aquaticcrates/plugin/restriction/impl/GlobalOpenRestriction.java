...
public final class GlobalOpenRestriction extends OpenRestriction {
   ...
   public Boolean execute(@NotNull OpenData var1, @NotNull ObjectArguments var2, @NotNull Function2<? super OpenData, ? super String, String> var3) {
      ...
      Integer var10000 = var2.int("radius", GlobalOpenRestriction::execute$lambda$0);
      if (var10000 == null) {
         return true;
      } else {
         int var4 = var10000;
         Location var5 = var1.getLocation();
         OpenableCrate var6 = var1.getCrate();
         Collection var12 = var6.getAnimationManager().getPlayingAnimations().values();
         Intrinsics.checkNotNullExpressionValue(var12, "<get-values>(...)");
         Collection var7 = var12;
         if (var7.isEmpty()) {
            return true;
         } else {
            ...
            while(var8.hasNext()) {
               ...
               while(var10.hasNext()) {
                  CrateAnimation var11 = (CrateAnimation)var10.next();
                  if (Intrinsics.areEqual(var11.getBaseLocation().getWorld(), var5.getWorld()) && var11.getBaseLocation().distanceSquared(var5) <= (double)(var4 * var4)) {
                     return false;
                  }
               }
            }
