...
public final class BMHideModelAction implements ExecutableObject<Animation, Unit> {
   ...
   public void execute(@NotNull Animation var1, @NotNull ObjectArguments var2, @NotNull Function2<? super Animation, ? super String, String> var3) {
      ...
      String var10000 = var2.string("id", BMHideModelAction::execute$lambda$0);
      if (var10000 != null) {
         String var4 = var10000;
         AnimationProp var6 = (AnimationProp)var1.getProps().get("model:" + var4);
         if (var6 != null) {
            AnimationProp var5 = var6;
            var5.onAnimationEnd();
            var1.getProps().remove("model:" + var4);
         }
      }
   }
