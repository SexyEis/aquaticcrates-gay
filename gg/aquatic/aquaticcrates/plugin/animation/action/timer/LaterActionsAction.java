...
@Metadata(
   ...
   d2 = {"Lgg/aquatic/aquaticcrates/plugin/animation/action/timer/LaterActionsAction;", "Lgg/aquatic/waves/util/generic/ExecutableObject;", "Lgg/aquatic/aquaticcrates/api/animation/Animation;", "", "Lgg/aquatic/waves/util/generic/Action;", "<init>", "()V", "arguments", "", "Lgg/aquatic/waves/util/argument/AquaticObjectArgument;", "getArguments", "()Ljava/util/List;", "execute", "binder", "args", "Lgg/aquatic/waves/util/argument/ObjectArguments;", "textUpdater", "Lgg/aquatic/waves/libs/kotlin/Function2;", "", "plugin"}
)
@SourceDebugExtension({"SMAP\nLaterActionsAction.kt\nKotlin\n*S Kotlin\n*F\n+ 1 LaterActionsAction.kt\ngg/aquatic/aquaticcrates/plugin/animation/action/timer/LaterActionsAction\n+ 2 ObjectArguments.kt\ngg/aquatic/waves/util/argument/ObjectArguments\n*L\n1#1,29:1\n98#2,2:30\n*S KotlinDebug\n*F\n+ 1 LaterActionsAction.kt\ngg/aquatic/aquaticcrates/plugin/animation/action/timer/LaterActionsAction\n*L\n21#1:30,2\n*E\n"})
public final class LaterActionsAction implements ExecutableObject<Animation, Unit> {
   @NotNull
   private final List<AquaticObjectArgument<?>> arguments;

   public LaterActionsAction() {
      AquaticObjectArgument[] var1 = new AquaticObjectArgument[]{new PrimitiveObjectArgument("delay", 0, true), new ActionsArgument("actions", (CrateAnimationActions)null, true)};
   ...
   public void execute(@NotNull Animation var1, @NotNull ObjectArguments var2, @NotNull Function2<? super Animation, ? super String, String> var3) {
      ...
      Integer var10000 = var2.int("delay", LaterActionsAction::execute$lambda$0);
      if (var10000 != null) {
         int var4 = var10000;
         String var7 = "actions";
         Function1 var8 = (Function1)LaterActionsAction$execute$$inlined$typed$default$1.INSTANCE;
         boolean var9 = false;
         Object var10 = var2.any(var7, var8);
         if (!(var10 instanceof CrateAnimationActions)) {
            var10 = null;
         }

         CrateAnimationActions var11 = (CrateAnimationActions)var10;
         if (var11 != null) {
            CrateAnimationActions var5 = var11;
            LaterActionsAnimationProp var6 = new LaterActionsAnimationProp(var1, var5, var4);
            var1.getProps().put("later-actions:" + UUID.randomUUID(), var6);
         }
      }
   }
