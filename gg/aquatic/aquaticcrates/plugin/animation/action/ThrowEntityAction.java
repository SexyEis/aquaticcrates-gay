...
@Metadata(
   ...
   d2 = {"Lgg/aquatic/aquaticcrates/plugin/animation/action/ThrowEntityAction;", "Lgg/aquatic/waves/util/generic/ExecutableObject;", "Lgg/aquatic/aquaticcrates/api/animation/Animation;", "", "Lgg/aquatic/waves/util/generic/Action;", "<init>", "()V", "arguments", "", "Lgg/aquatic/waves/util/argument/AquaticObjectArgument;", "getArguments", "()Ljava/util/List;", "execute", "binder", "args", "Lgg/aquatic/waves/util/argument/ObjectArguments;", "textUpdater", "Lgg/aquatic/waves/libs/kotlin/Function2;", "", "plugin"}
)
public final class ThrowEntityAction implements ExecutableObject<Animation, Unit> {
   @NotNull
   private final List<AquaticObjectArgument<?>> arguments;

   public ThrowEntityAction() {
      PrimitiveObjectArgument[] var1 = new PrimitiveObjectArgument[]{new PrimitiveObjectArgument("velocity", "0;0;0", false), new PrimitiveObjectArgument("power", 1.0D, false), new PrimitiveObjectArgument("prop", "entity:example", true)};
   ...
   public void execute(@NotNull Animation var1, @NotNull ObjectArguments var2, @NotNull Function2<? super Animation, ? super String, String> var3) {
      ...
      Vector var10000 = var2.vector("velocity", ThrowEntityAction::execute$lambda$0);
      if (var10000 != null) {
         Vector var4 = var10000;
         Double var9 = var2.double("power", ThrowEntityAction::execute$lambda$1);
         double var5 = var9 != null ? var9 : 0.0D;
         String var10 = var2.string("prop", ThrowEntityAction::execute$lambda$2);
         if (var10 == null) {
            var10 = "entity:example";
         }

         String var7 = var10;
         AnimationProp var11 = (AnimationProp)var1.getProps().get(var7);
         if (var11 != null) {
            AnimationProp var8 = var11;
            if (var8 instanceof Throwable) {
               Throwable var12 = (Throwable)var8;
               Vector var10001 = var4.clone().multiply(var5);
               Intrinsics.checkNotNullExpressionValue(var10001, "multiply(...)");
               var12.throwObject(var10001);
            }
         }
      }
   }
