...
public final class CloseInventoryAction implements ExecutableObject<PlayerBoundAnimation, Unit> {
   ...
   public void execute(@NotNull PlayerBoundAnimation var1, @NotNull ObjectArguments var2, @NotNull Function2<? super PlayerBoundAnimation, ? super String, String> var3) {
      ...
      if (var10000 != null) {
         AnimationProp var5 = var10000;
         InventoryAnimationProp var6 = var5 instanceof InventoryAnimationProp ? (InventoryAnimationProp)var5 : null;
         if ((var5 instanceof InventoryAnimationProp ? (InventoryAnimationProp)var5 : null) != null) {
            InventoryAnimationProp var4 = var6;
            var1.getProps().remove("inventory");
            var4.getMenu().close();
         }
      }
   }
