...
public final class SetInventoryTitleAction implements ExecutableObject<PlayerBoundAnimation, Unit> {
   ...
   public void execute(@NotNull PlayerBoundAnimation var1, @NotNull ObjectArguments var2, @NotNull Function2<? super PlayerBoundAnimation, ? super String, String> var3) {
      ...
      if (var10000 != null) {
         AnimationProp var6 = var10000;
         InventoryAnimationProp var7 = var6 instanceof InventoryAnimationProp ? (InventoryAnimationProp)var6 : null;
         if ((var6 instanceof InventoryAnimationProp ? (InventoryAnimationProp)var6 : null) != null) {
            InventoryAnimationProp var4 = var7;
            String var8 = var2.string("title", SetInventoryTitleAction::execute$lambda$0);
            if (var8 != null) {
               String var5 = var8;
               var4.getMenu().setTitle(StringExtKt.toMMComponent(var1.updatePlaceholders(var5)));
            }
         }
      }
   }
