...
public final class SetBossbarTextAction implements ExecutableObject<Animation, Unit> {
   ...
   public void execute(@NotNull Animation var1, @NotNull ObjectArguments var2, @NotNull Function2<? super Animation, ? super String, String> var3) {
      ...
      String var10000 = var2.string("id", SetBossbarTextAction::execute$lambda$0);
      if (var10000 != null) {
