...
public final class HideBossbarAction implements ExecutableObject<Animation, Unit> {
   ...
   public void execute(@NotNull Animation var1, @NotNull ObjectArguments var2, @NotNull Function2<? super Animation, ? super String, String> var3) {
      ...
      String var10000 = var2.string("id", HideBossbarAction::execute$lambda$0);
      if (var10000 != null) {
         String var4 = var10000;
         Object var6 = var1.getProps().get("bossbar:" + var4);
         BossbarAnimationProp var7 = var6 instanceof BossbarAnimationProp ? (BossbarAnimationProp)var6 : null;
         if ((var6 instanceof BossbarAnimationProp ? (BossbarAnimationProp)var6 : null) != null) {
            BossbarAnimationProp var5 = var7;
            var5.onAnimationEnd();
         }
      }
   }
