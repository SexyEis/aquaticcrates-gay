...
@Metadata(
   ...
   d2 = {"Lgg/aquatic/aquaticcrates/plugin/animation/action/bossbar/SetBossbarProgressAction;", "Lgg/aquatic/waves/util/generic/ExecutableObject;", "Lgg/aquatic/aquaticcrates/api/animation/Animation;", "", "Lgg/aquatic/waves/util/generic/Action;", "<init>", "()V", "arguments", "", "Lgg/aquatic/waves/util/argument/AquaticObjectArgument;", "getArguments", "()Ljava/util/List;", "execute", "binder", "args", "Lgg/aquatic/waves/util/argument/ObjectArguments;", "textUpdater", "Lgg/aquatic/waves/libs/kotlin/Function2;", "", "plugin"}
)
public final class SetBossbarProgressAction implements ExecutableObject<Animation, Unit> {
   @NotNull
   private final List<AquaticObjectArgument<?>> arguments;

   public SetBossbarProgressAction() {
      PrimitiveObjectArgument[] var1 = new PrimitiveObjectArgument[]{new PrimitiveObjectArgument("id", "bossbar", true), new PrimitiveObjectArgument("progress", 0.0D, true)};
   ...
   public void execute(@NotNull Animation var1, @NotNull ObjectArguments var2, @NotNull Function2<? super Animation, ? super String, String> var3) {
      ...
      String var10000 = var2.string("id", SetBossbarProgressAction::execute$lambda$0);
      if (var10000 != null) {
         String var4 = var10000;
         Float var8 = var2.float("progress", SetBossbarProgressAction::execute$lambda$1);
         if (var8 != null) {
            float var5 = var8;
            Object var7 = var1.getProps().get("bossbar:" + var4);
            BossbarAnimationProp var9 = var7 instanceof BossbarAnimationProp ? (BossbarAnimationProp)var7 : null;
            if ((var7 instanceof BossbarAnimationProp ? (BossbarAnimationProp)var7 : null) != null) {
               BossbarAnimationProp var6 = var9;
               var6.getBossBar().setProgress(var5);
            }
         }
      }
   }
