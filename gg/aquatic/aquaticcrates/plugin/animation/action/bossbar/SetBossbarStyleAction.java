...
public final class SetBossbarStyleAction implements ExecutableObject<Animation, Unit> {
   ...
   public void execute(@NotNull Animation var1, @NotNull ObjectArguments var2, @NotNull Function2<? super Animation, ? super String, String> var3) {
      ...
      String var10000 = var2.string("id", SetBossbarStyleAction::execute$lambda$0);
      if (var10000 != null) {
         String var4 = var10000;
         var10000 = var2.string("style", SetBossbarStyleAction::execute$lambda$1);
         if (var10000 != null) {
            String var5 = var10000;
            Object var7 = var1.getProps().get("bossbar:" + var4);
            BossbarAnimationProp var8 = var7 instanceof BossbarAnimationProp ? (BossbarAnimationProp)var7 : null;
            if ((var7 instanceof BossbarAnimationProp ? (BossbarAnimationProp)var7 : null) != null) {
               BossbarAnimationProp var6 = var8;
               AquaticBossBar var9 = var6.getBossBar();
               String var10001 = var5.toUpperCase(Locale.ROOT);
               Intrinsics.checkNotNullExpressionValue(var10001, "toUpperCase(...)");
               var9.setOverlay(Overlay.valueOf(var10001));
            }
         }
      }
   }
