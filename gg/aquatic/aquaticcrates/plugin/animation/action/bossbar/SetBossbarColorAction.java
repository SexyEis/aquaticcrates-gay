...
public final class SetBossbarColorAction implements ExecutableObject<Animation, Unit> {
   ...
   public void execute(@NotNull Animation var1, @NotNull ObjectArguments var2, @NotNull Function2<? super Animation, ? super String, String> var3) {
      ...
      String var10000 = var2.string("id", SetBossbarColorAction::execute$lambda$0);
      if (var10000 != null) {
         String var4 = var10000;
         var10000 = var2.string("color", SetBossbarColorAction::execute$lambda$1);
         if (var10000 != null) {
            ...
            if ((var7 instanceof BossbarAnimationProp ? (BossbarAnimationProp)var7 : null) != null) {
               ...
               var9.setColor(Color.valueOf(var10001));
            }
         }
      }
   }
