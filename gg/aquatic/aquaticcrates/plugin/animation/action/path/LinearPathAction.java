...
@Metadata(
   ...
   d2 = {"Lgg/aquatic/aquaticcrates/plugin/animation/action/path/LinearPathAction;", "Lgg/aquatic/waves/util/generic/ExecutableObject;", "Lgg/aquatic/aquaticcrates/api/animation/Animation;", "", "Lgg/aquatic/waves/util/generic/Action;", "<init>", "()V", "arguments", "", "Lgg/aquatic/waves/util/argument/AquaticObjectArgument;", "getArguments", "()Ljava/util/List;", "execute", "binder", "args", "Lgg/aquatic/waves/util/argument/ObjectArguments;", "textUpdater", "Lgg/aquatic/waves/libs/kotlin/Function2;", "", "plugin"}
)
@SourceDebugExtension({"SMAP\nLinearPathAction.kt\nKotlin\n*S Kotlin\n*F\n+ 1 LinearPathAction.kt\ngg/aquatic/aquaticcrates/plugin/animation/action/path/LinearPathAction\n+ 2 ObjectArguments.kt\ngg/aquatic/waves/util/argument/ObjectArguments\n*L\n1#1,27:1\n98#2,2:28\n*S KotlinDebug\n*F\n+ 1 LinearPathAction.kt\ngg/aquatic/aquaticcrates/plugin/animation/action/path/LinearPathAction\n*L\n20#1:28,2\n*E\n"})
public final class LinearPathAction implements ExecutableObject<Animation, Unit> {
   @NotNull
   private final List<AquaticObjectArgument<?>> arguments;

   public LinearPathAction() {
      AquaticObjectArgument[] var1 = new AquaticObjectArgument[]{new PrimitiveObjectArgument("id", "linear-path1", true), new PathPointsArgument("points", new TreeMap(), true)};
   ...
   public void execute(@NotNull Animation var1, @NotNull ObjectArguments var2, @NotNull Function2<? super Animation, ? super String, String> var3) {
      ...
      String var10000 = var2.string("id", LinearPathAction::execute$lambda$0);
      if (var10000 != null) {
         String var4 = var10000;
         String var7 = "points";
         Function1 var8 = (Function1)LinearPathAction$execute$$inlined$typed$default$1.INSTANCE;
         boolean var9 = false;
         ...
         if (var11 != null) {
            TreeMap var5 = var11;
            LinearPathProp var6 = new LinearPathProp(var5, var1);
