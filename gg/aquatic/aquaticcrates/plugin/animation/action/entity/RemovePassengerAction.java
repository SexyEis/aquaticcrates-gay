...
public final class RemovePassengerAction implements ExecutableObject<Animation, Unit> {
   ...
   public void execute(@NotNull Animation var1, @NotNull ObjectArguments var2, @NotNull Function2<? super Animation, ? super String, String> var3) {
      ...
      String var10000 = var2.string("passenger", RemovePassengerAction::execute$lambda$0);
      if (var10000 != null) {
         String var4 = var10000;
         Object var7 = var1.getProps().get(var4);
         EntityAnimationProp var9 = var7 instanceof EntityAnimationProp ? (EntityAnimationProp)var7 : null;
         if ((var7 instanceof EntityAnimationProp ? (EntityAnimationProp)var7 : null) != null) {
            EntityAnimationProp var5 = var9;
            var10000 = var2.string("seat", RemovePassengerAction::execute$lambda$1);
            if (var10000 != null) {
               String var6 = var10000;
               Object var8 = var1.getProps().get(var6);
               Seatable var10 = var8 instanceof Seatable ? (Seatable)var8 : null;
               if ((var8 instanceof Seatable ? (Seatable)var8 : null) != null) {
                  Seatable var11 = var10;
                  var11.removePassenger(var5);
               }
            }
         }
      }
