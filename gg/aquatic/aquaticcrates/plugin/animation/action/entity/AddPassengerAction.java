...
public final class AddPassengerAction implements ExecutableObject<Animation, Unit> {
   ...
   public void execute(@NotNull Animation var1, @NotNull ObjectArguments var2, @NotNull Function2<? super Animation, ? super String, String> var3) {
      ...
      String var10000 = var2.string("passenger", AddPassengerAction::execute$lambda$0);
      if (var10000 != null) {
         ...
         if ((var7 instanceof EntityAnimationProp ? (EntityAnimationProp)var7 : null) != null) {
            ...
            var10000 = var2.string("seat", AddPassengerAction::execute$lambda$1);
            if (var10000 != null) {
