...
public final class StopSoundAction implements ExecutableObject<PlayerBoundAnimation, Unit> {
   ...
   public void execute(@NotNull PlayerBoundAnimation var1, @NotNull ObjectArguments var2, @NotNull Function2<? super PlayerBoundAnimation, ? super String, String> var3) {
      ...
      String var10000 = var2.string("sound", StopSoundAction::execute$lambda$0);
      if (var10000 != null) {
         String var4 = var10000;
         var1.getPlayer().stopSound(var4);
      }
   }
