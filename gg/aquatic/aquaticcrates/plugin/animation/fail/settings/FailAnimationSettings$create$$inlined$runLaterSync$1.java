...
public final class FailAnimationSettings$create$$inlined$runLaterSync$1 implements Runnable {
   // $FF: synthetic field
   final SpawnedCrate $spawnedCrate$inlined;
   // $FF: synthetic field
   final Player $player$inlined;

   public FailAnimationSettings$create$$inlined$runLaterSync$1(SpawnedCrate var1, Player var2) {
