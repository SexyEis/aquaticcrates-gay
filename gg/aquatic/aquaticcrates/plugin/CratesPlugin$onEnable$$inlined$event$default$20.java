...
public final class CratesPlugin$onEnable$$inlined$event$default$20 implements EventExecutor {
   // $FF: synthetic field
   final Consumer $callback;

   public CratesPlugin$onEnable$$inlined$event$default$20(Consumer var1) {
      this.$callback = var1;
   }
   ...
   public final void execute(Listener var1, Event var2) {
      ...
      if (var2 instanceof PacketContainerContentEvent) {
