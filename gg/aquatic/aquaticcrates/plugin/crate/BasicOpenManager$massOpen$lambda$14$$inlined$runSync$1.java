...
public final class BasicOpenManager$massOpen$lambda$14$$inlined$runSync$1 implements Runnable {
   // $FF: synthetic field
   final BasicOpenManager this$0;
   // $FF: synthetic field
   final Player $player$inlined;
   // $FF: synthetic field
   final int $totalWon$inlined;
   // $FF: synthetic field
   final int $totalWonExcluded$inlined;

   public BasicOpenManager$massOpen$lambda$14$$inlined$runSync$1(BasicOpenManager var1, Player var2, int var3, int var4) {
      this.this$0 = var1;
      this.$player$inlined = var2;
      this.$totalWon$inlined = var3;
      this.$totalWonExcluded$inlined = var4;
   }
