...
public final class BasicOpenManager$massOpen$lambda$14$$inlined$runSync$2 implements Runnable {
   // $FF: synthetic field
   final BasicOpenManager this$0;
   // $FF: synthetic field
   final Player $player$inlined;
   // $FF: synthetic field
   final Reward $reward$inlined;
   // $FF: synthetic field
   final int $amt$inlined;
   // $FF: synthetic field
   final int $amtTotal$inlined;

   public BasicOpenManager$massOpen$lambda$14$$inlined$runSync$2(BasicOpenManager var1, Player var2, Reward var3, int var4, int var5) {
      this.this$0 = var1;
      this.$player$inlined = var2;
      this.$reward$inlined = var3;
      this.$amt$inlined = var4;
      this.$amtTotal$inlined = var5;
   }
