...
public final class CrateBreakAction implements ExecutableObject<CrateInteractAction, Unit> {
   ...
   public void execute(@NotNull CrateInteractAction var1, @NotNull ObjectArguments var2, @NotNull Function2<? super CrateInteractAction, ? super String, String> var3) {
      ...
      if (var1.getPlayer().hasPermission("aquaticcrates.admin")) {
         SpawnedCrate var10000 = var1.getSpawnedCrate();
         if (var10000 != null) {
            SpawnedCrate var4 = var10000;
            var4.destroy();
            ((Map)CrateHandler.INSTANCE.getSpawned()).remove(var4.getLocation());
            CrateHandler.INSTANCE.saveSpawnedCrates(CratesPlugin.Companion.getSpawnedCratesConfig());
         }
      }
   }
}
