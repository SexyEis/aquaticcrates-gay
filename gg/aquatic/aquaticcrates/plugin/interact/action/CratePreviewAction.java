...
public final class CratePreviewAction implements ExecutableObject<CrateInteractAction, Unit> {
   ...
   public void execute(@NotNull CrateInteractAction var1, @NotNull ObjectArguments var2, @NotNull Function2<? super CrateInteractAction, ? super String, String> var3) {
      ...
      if (var4 instanceof BasicCrate) {
         Player var5 = var1.getPlayer();
         ((BasicCrate)var4).openPreview(var5, var1.getSpawnedCrate());
      }
   }
}
