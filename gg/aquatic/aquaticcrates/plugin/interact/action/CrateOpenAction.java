...
public final class CrateOpenAction implements ExecutableObject<CrateInteractAction, Unit> {
   ...
   public void execute(@NotNull CrateInteractAction var1, @NotNull ObjectArguments var2, @NotNull Function2<? super CrateInteractAction, ? super String, String> var3) {
      ...
      if (var4 instanceof OpenableCrate) {
         ((OpenableCrate)var4).tryOpen(var1.getPlayer(), var1.getInteractedLocation(), var1.getSpawnedCrate());
      }
