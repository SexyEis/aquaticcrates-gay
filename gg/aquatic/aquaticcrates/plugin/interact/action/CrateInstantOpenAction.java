...
public final class CrateInstantOpenAction implements ExecutableObject<CrateInteractAction, Unit> {
   ...
   public void execute(@NotNull CrateInteractAction var1, @NotNull ObjectArguments var2, @NotNull Function2<? super CrateInteractAction, ? super String, String> var3) {
      ...
      Crate var4 = var1.getCrate();
      Player var5 = var1.getPlayer();
      if (var4 instanceof OpenableCrate) {
         ((OpenableCrate)var4).tryInstantOpen(var5, var1.getInteractedLocation(), var1.getSpawnedCrate());
      }
