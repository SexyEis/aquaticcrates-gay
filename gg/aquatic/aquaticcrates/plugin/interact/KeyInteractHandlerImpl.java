...
@Metadata(
   ...
   d2 = {"Lgg/aquatic/aquaticcrates/plugin/interact/KeyInteractHandlerImpl;", "Lgg/aquatic/aquaticcrates/api/interaction/key/KeyInteractHandler;", "key", "Lgg/aquatic/aquaticcrates/api/crate/Key;", "clickActions", "Ljava/util/EnumMap;", "Lgg/aquatic/waves/item/AquaticItemInteractEvent$InteractType;", "Lgg/aquatic/waves/util/generic/ConfiguredExecutableObject;", "Lgg/aquatic/aquaticcrates/api/interaction/CrateInteractAction;", "", "<init>", "(Lgg/aquatic/aquaticcrates/api/crate/Key;Ljava/util/EnumMap;)V", "getKey", "()Lgg/aquatic/aquaticcrates/api/crate/Key;", "getClickActions", "()Ljava/util/EnumMap;", "handleInteract", "", "player", "Lorg/bukkit/entity/Player;", "interactType", "interactedLocation", "Lorg/bukkit/Location;", "crate", "Lgg/aquatic/aquaticcrates/api/crate/SpawnedCrate;", "plugin"}
)
public final class KeyInteractHandlerImpl extends KeyInteractHandler {
   @NotNull
   private final Key key;
   @NotNull
   private final EnumMap<InteractType, ConfiguredExecutableObject<CrateInteractAction, Unit>> clickActions;

   public KeyInteractHandlerImpl(@NotNull Key var1, @NotNull EnumMap<InteractType, ConfiguredExecutableObject<CrateInteractAction, Unit>> var2) {
   ...
   public boolean handleInteract(@NotNull Player var1, @NotNull InteractType var2, @NotNull Location var3, @Nullable SpawnedCrate var4) {
      ...
      if (var10000 == null) {
         ...
         var5.execute(new CrateInteractAction(this.getKey().getCrate(), var1, var2, var3, var4), KeyInteractHandlerImpl::handleInteract$lambda$0);
         return true;
      }
   }
