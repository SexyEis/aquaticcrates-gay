...
@Metadata(
   ...
   d2 = {"Lgg/aquatic/aquaticcrates/plugin/command/LogCommand;", "Lgg/aquatic/waves/command/ICommand;", "<init>", "()V", "run", "", "sender", "Lorg/bukkit/command/CommandSender;", "args", "", "", "(Lorg/bukkit/command/CommandSender;[Ljava/lang/String;)V", "tabComplete", "", "(Lorg/bukkit/command/CommandSender;[Ljava/lang/String;)Ljava/util/List;", "plugin"}
)
public final class LogCommand implements ICommand {
   @NotNull
   ...
   public void run(@NotNull CommandSender var1, @NotNull String[] var2) {
      ...
      if (var1 instanceof Player) {
         if (var1.hasPermission("aquaticcrates.admin")) {
            ...
            LogMenu var3 = new LogMenu(((CratesPlugin)var10002).getLogMenuSettings(), (Player)var1);
            var3.open();
         }
      }
   }
