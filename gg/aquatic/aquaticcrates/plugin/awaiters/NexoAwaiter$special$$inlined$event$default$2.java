...
public final class NexoAwaiter$special$$inlined$event$default$2 implements EventExecutor {
   // $FF: synthetic field
   final Consumer $callback;

   public NexoAwaiter$special$$inlined$event$default$2(Consumer var1) {
      this.$callback = var1;
   }
   ...
   public final void execute(Listener var1, Event var2) {
      ...
      if (var2 instanceof NexoItemsLoadedEvent) {
