...
public final class CratesPlugin$onEnable$$inlined$event$default$14 implements EventExecutor {
   // $FF: synthetic field
   final Consumer $callback;

   public CratesPlugin$onEnable$$inlined$event$default$14(Consumer var1) {
      this.$callback = var1;
   }
